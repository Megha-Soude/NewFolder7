  ...
  iconMenu: IMenuItem[] = [
   ...
   
    {
      ...
      sub: [
        ...
        { name: "Inventory List", state: "InventoryList" }
        // ,
        // { name: "Add Inventory", state: "Addinventory" }
      ]
    },

    {
      ...
      sub: [
        // { name: "Add Deposit", state: "AddDeposit" },
        // { name: "Add Auction", state: "AddAuction" },
        { name: "Auction List", state: "AuctionList" }
      ]
    },
    {
      name: "Bid",
      ...
      sub: [
        // { name: "Add Deposit", state: "AddDeposit" },
        // { name: "Bid List", state: "BidList" },
        { name: "Current Bid List", state: "CurrentBidlist" },
        { name: "Closed Bid List", state: "ClosedBidList" },
    ...
    ,
    {
      ...
      sub: [
        // { name: "Add Deposit", state: "AddDeposit" },
        { name: "Customer User",  state:  "CustomerUser"  },
        { name: "Buyer Users", state: "BuyerUser" },
        { name: "Admin Users", state: "UserList" },
        { name: "Party Type Master", state: "PartTypemaster" },
        { name: "Access Managment", state: "AccessManagment" },

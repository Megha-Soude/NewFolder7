...
@Component({
  selector: 'app-advance-filter-closed-current-bidlist',
  templateUrl: './advance-filter-closed-current-bidlist.component.html',
  styleUrls: ['./advance-filter-closed-current-bidlist.component.scss'], encapsulation: ViewEncapsulation.None,
  providers: [
    { provide: DateAdapter, useClass: AppDateAdapter },
    { provide: MAT_DATE_FORMATS, useValue: APP_DATE_FORMATS }
  ]
})
export class AdvanceFilterClosedCurrentBidlistComponent implements OnInit {
  ...
  constructor(
    ...
    private fb: FormBuilder, private commonService: CommonService ,  private datepipe: DatePipe
